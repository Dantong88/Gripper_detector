...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str,
                        default='/home/niudt/robotic_project/detectron2/tools/bimanual_detector_40epoch/model_final.pth')
    ...
    supported_objs = {0: {'id': 1, 'name': 'object', 'color': [220, 20, 60], 'isthing': 1}}


    COCO_CATEGORIES = [{'id': 0, 'name': 'blue cube', 'color': [220, 20, 60], 'isthing': 1},
                       {'id': 1, 'name': 'green cube', 'color': [220, 20, 60], 'isthing': 1},
                       {'id': 2, 'name': 'magenta cube', 'color': [220, 20, 60], 'isthing': 1},
                       {'id': 3, 'name': 'orange cube', 'color': [220, 20, 60], 'isthing': 1},
                       {'id': 4, 'name': 'purple cube', 'color': [220, 20, 60], 'isthing': 1},
                       {'id': 5, 'name': 'red cube', 'color': [220, 20, 60], 'isthing': 1},
                       {'id': 6, 'name': 'yellow cube', 'color': [220, 20, 60], 'isthing': 1}
                       ]

    # here is the forloop to process the data
    # demos = glob(os.path.join('/scratch/partial_datasets/lvma/lego_project/data/pkl_adapted', '*/*/*/*'))
    ...
    for demo in tqdm(demos):
        ...
        for pkl in pkls:
            ...
            if 'rgb_left.png' in bbox_det and 'rgb_right.png' in bbox_det:
                data['bbox_head'] = bbox_det['rgb_left.png']
                data['bbox_wrist'] = bbox_det['rgb_right.png']
